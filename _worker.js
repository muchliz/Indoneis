...
// Variables
const rootDomain = "muchliz.my.id";
const serviceName = "ojo dumeh";
const apiKey = "081d1bc4b4793c6e7f94251524f4733c216d7";
const apiEmail = "muchlizpras86@gmail.com";
const accountID = "9ca36c81724fd1a4d0d560c52a6ee69c";
const zoneID = "211c488539bf5c01ce13cde6d332c147";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Sugeng Rawuh Ing <span class='text-green-500 font-semibold'>Ojo Dumeh</span>");
